/**
 * Customer Key Takeaways — renders the markdown body uploaded against the
 * "customer-key-takeaways" help entry. Same render path as Highlights.
 */
...
const ENTRY_ID = "customer-key-takeaways";
  ...
  if (!content.trim()) {
    return (
      <Stack spacing={2} sx={{ py: 4, alignItems: "flex-start" }}>
        ...
        <Typography sx={{ fontSize: 14, fontWeight: 600 }}>No key takeaways uploaded yet</Typography>
