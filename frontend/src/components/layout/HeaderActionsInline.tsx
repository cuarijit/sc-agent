/**
 * HeaderActionsInline — filter + agent buttons rendered inline in the
 * right side of every PageShell header, vertically centered with the title
 * (matches puls8 Analytics page layout).
 */
...
export default function HeaderActionsInline({
  filters,
  setFilters,
  config,
  openAiApiKey,
  ...
  return (
    <>
      <Stack direction="row" alignItems="center" spacing={0.5}>
        <Tooltip title={activeCount > 0 ? `${activeCount} active filter${activeCount === 1 ? "" : "s"}` : "Manual filter"}>
          <IconButton
            size="small"
        ...
        <Tooltip title="Open Data Search Agent">
          <IconButton
            size="small"
            color="primary"
